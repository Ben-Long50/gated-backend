...
router.patch('/items/:itemId/stats/refreshAmmo', authentication.authenticate, itemStatController.refreshAmmo);
router.patch('/items/:itemId/stats/currentBlock', authentication.authenticate, itemStatController.editItemBlock);
router.patch('/items/:itemId/stats/refreshBlock', authentication.authenticate, itemStatController.refreshItemBlock);
...
router.patch('/items/:itemId/stats/currentHull', authentication.authenticate, itemStatController.editItemHull);
router.patch('/items/:itemId/stats/currentCargo', authentication.authenticate, itemStatController.editItemCargo);
router.patch('/items/:itemId/stats/currentPass', authentication.authenticate, itemStatController.editItemPass);
router.delete('/items/:category/:itemId', authentication.authenticate, authentication.authenticateAdmin, itemController.deleteItem);
