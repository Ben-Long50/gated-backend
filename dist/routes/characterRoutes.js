...
router.get('/characters/:characterId/equipment', authentication.authenticate, characterController.getEquippedItems);
router.patch('/characters/:characterId/equipment/:itemId', authentication.authenticate, characterController.toggleEquipment);
