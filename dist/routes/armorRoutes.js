...
router.patch('/armor/:itemId/stats/currentPower', authentication.authenticate, itemStatController.editItemPower);
router.patch('/armor/:itemId/stats/currentBlock', authentication.authenticate, itemStatController.editItemBlock);
router.patch('/armor/:itemId/stats/refreshPower', authentication.authenticate, itemStatController.refreshItemPower);
router.patch('/armor/:itemId/stats/refreshBlock', authentication.authenticate, itemStatController.refreshItemBlock);
