...
const cartServices = {
  editCartWeapon: async (cartId: number, itemId: number, value: number) => {
    try {
  ...
  editCartArmor: async (cartId: number, itemId: number, value: number) => {
    try {
  ...
  editCartCybernetic: async (cartId: number, itemId: number, value: number) => {
    try {
  ...
  editCartVehicle: async (cartId: number, itemId: number, value: number) => {
    try {
  ...
  editCartDrone: async (cartId: number, itemId: number, value: number) => {
    try {
